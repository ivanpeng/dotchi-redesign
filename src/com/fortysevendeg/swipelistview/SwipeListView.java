...
public class SwipeListView extends ListView {
     ...
     */
    public SwipeListView(Context context, int swipeBackView, int swipeFrontView, int swipeLeftView, int swipeRightView) {
        super(context);
        this.swipeFrontView = swipeFrontView;
        this.swipeBackView = swipeBackView;
        this.swipeLeftView = swipeLeftView;
        this.swipeRightView = swipeRightView;
        init(null);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            swipeLeftView = styled.getResourceId(R.styleable.SwipeListView_swipeLeftView, 0);
            swipeRightView = styled.getResourceId(R.styleable.SwipeListView_swipeRightView, 0);
        }
        ...
        touchListener = new SwipeListViewTouchListener(this, swipeFrontView, swipeBackView, swipeLeftView, swipeRightView);
