...
public class SwipeListViewTouchListener implements View.OnTouchListener {
     ...
     */
    public SwipeListViewTouchListener(SwipeListView swipeListView, int swipeFrontView, int swipeBackView, int swipeLeftView, int swipeRightView) {
        this.swipeFrontView = swipeFrontView;
        this.swipeBackView = swipeBackView;
        LayoutInflater inflater = (LayoutInflater) swipeListView.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        if (swipeLeftView > 0)
        	this.swipeLeftView = inflater.inflate(swipeLeftView, null);
        if (swipeRightView > 0)
        	this.swipeRightView = inflater.inflate(swipeRightView, null);
...
//                }
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                //Log.d("ss", String.valueOf(swipingRight));
                if (deltaMode > slop && swipeCurrentAction == SwipeListView.SWIPE_ACTION_NONE && velocityY < velocityX) {
                    ...
                    if (swipingRight)	{
                    	backView.setBackgroundResource(R.drawable.swipe_right_background);
                    }
                    else	{
                    	backView.setBackgroundResource(R.drawable.swipe_left_background);
                    }
